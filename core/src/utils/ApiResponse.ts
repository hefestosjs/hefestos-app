...
import { ResponseInterface } from "../interfaces/router";
...
export default {
  ...
  pagination: function (res: ResponseInterface, data: any): void {
  ...
  appError: function (res: ResponseInterface, error: AppError): void {
